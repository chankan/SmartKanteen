...
------Insert Scripts for ROLE-------
--------------------------------------------------------------------
INSERT INTO  ROLE (ROLE_ID,ROLE_NAME)VALUES(1,'Super Admin');
INSERT INTO  ROLE (ROLE_ID,ROLE_NAME)VALUES(2,' Admin');
INSERT INTO  ROLE (ROLE_ID,ROLE_NAME)VALUES(3,'User');


-----Insert Script for User_Role_Mapping
--------------------------------------------------------------------
INSERT INTO USER_ROLE_MAPPING(ROLE_ID,USER_ID)VALUES(3,1); 
INSERT INTO USER_ROLE_MAPPING(ROLE_ID,USER_ID)VALUES(3,2);
INSERT INTO USER_ROLE_MAPPING(ROLE_ID,USER_ID)VALUES(3,3);  


-----Insert Script for User_Caterer_Mapping
--------------------------------------------------------------------
INSERT INTO USER_CATERER_MAPPING (USER_CATERER_MAPPING_ID, USER_ID, CATERER_ID) VALUES (1, 1, 1); 
