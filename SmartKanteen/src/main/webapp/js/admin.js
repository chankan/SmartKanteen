...
//	var MenuRestful = $resource('rest/service');
	var MenuService={
			...
			data1:[ 
			       ...
			       {ItemID: 4, ItemName: "Desertz", Description: "Gulam Jamoon",Price: 20,PrepTime: 10},
			       {ItemID: 5, ItemName: "Roti", Description: "Thanduri Roti",Price: 10,PrepTime: 20},
			       {ItemID: 6, ItemName: "Roti 1", Description: "Thanduri Roti",Price: 10,PrepTime: 20}
			       ],
			       menuIndex:6,
...
//			    	   this.data=[{ItemID: 1, ItemName: "Thali", Description: "Jain Thali",Price: 100,PrepTime: 15},];
//			    	   }).
...
.config(function($routeProvider) {
	...
	$scope.mainMenu = [ 
	                   {name : "Home",url : "#/"}, 
	                   {name : "Today's Menu",url : "#/dailymenu"}, 
...
//	}).
//	error(function(data, status, headers, config) {
//	$scope.menus=[{ItemID: 2, ItemName: "Thali", Description: "Jain Thali",Price: 100,PrepTime: 15},];
//	});
	$scope.remove = function(id) {
		var result=Menus.remove(id);
		if(result){
...
.controller('DailyMenuCtrl', function($scope, Menus,$resource,$http) {
	$scope.menudata =$resource('rest/kanteen/menu/caterer/1/date/2014-12-10').get();
//	$scope.menus =[{itemID: 1, itemName: "Thali", description: "Jain Thali",price: 100,prepTime: 15},];
...
.controller('CreateCtrl', function($scope, $location, Menus) {
	$scope.menu= {ItemID: -1, ItemName: "", Description: "",Price: 0,PrepTime: 0};
	$scope.save = function() {
